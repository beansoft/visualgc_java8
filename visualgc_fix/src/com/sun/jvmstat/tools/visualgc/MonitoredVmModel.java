  ...
  implements Model
{
  ...
  {
    if (this.finalizerInitialized) return;
    ...
    try
    {
      ...
      if (this.finalizerQLength == null) return;
  ...
  public MonitoredVmModel(MonitoredVm paramMonitoredVm) throws MonitorException {
  ...
  {
    if (this.lastGCCause == null) return null;
    return this.lastGCCause.stringValue();
  }

  public String getCurrentGCCause() {
    if (this.currentGCCause == null) return null;
  ...
  {
    if (this.ageTableSize == null) return;
  ...
  public long getFinalizerTime() {
    synchronized (this) {
      ...
      if (this.finalizerTime == null) return 0L;
