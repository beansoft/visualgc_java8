 ...
 */
package idea.plugin.psiviewer.copyable.view;
...
import idea.plugin.psiviewer.copyable.controller.application.PsiViewerApplicationSettings;
import idea.plugin.psiviewer.copyable.controller.project.PsiViewerProjectService;
import idea.plugin.psiviewer.copyable.util.PluginPsiUtil;
...
class EditorPsiElementHighlighter {
    ...
    private boolean isHighlightOn() {
        return PsiViewerProjectService.getInstance(_project).isHighlighted();
    }
