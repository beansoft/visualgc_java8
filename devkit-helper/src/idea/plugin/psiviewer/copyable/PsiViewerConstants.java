...
*/
package idea.plugin.psiviewer.copyable;
...
{
    // Plugin names
    String PLUGIN_NAME = "PsiViewerCopy";
    String CONFIGURATION_COMPONENT_NAME = "PsiViewerCopyablePluginSettings";
    ...
    // Ids
    String ID_TOOL_WINDOW = "PsiViewerCopy";
    String ID_ACTION_GROUP = "PsiCopyableActionGroup";
    String ID_ACTION_TOOLBAR = "PsiCopyableActionToolbar";
