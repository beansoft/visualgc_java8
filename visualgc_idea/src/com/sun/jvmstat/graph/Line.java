...
public class Line extends JComponent {
  // 图表中的跟随文字颜色
  public static final JBColor textInChartColor = new JBColor(Color.black, Color.white);

  public static final int DEFAULT_DATASET_SIZE = 1000;
  private static final int XSCALE = 2;// X zoom scale
  private static final Color SPLIT_GRID_COLOR = new Color(80, 80, 80);
  private Color color;
