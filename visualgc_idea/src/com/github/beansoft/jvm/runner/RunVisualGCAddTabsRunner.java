...
/**
 * This class can add additional tab to the runner UI, but a lot code need to be duplicated from DefaultJavaProgramRunner.
 */
public class RunVisualGCAddTabsRunner extends DefaultJavaProgramRunner {
	private static final Logger log = Logger.getInstance(RunVisualGCAddTabsRunner.class.getName());
