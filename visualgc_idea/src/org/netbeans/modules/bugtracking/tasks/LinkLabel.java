...
public abstract class LinkLabel extends JLabel implements MouseListener {
    ...
    private static final Color FOREGROUND_FOCUS_COLOR = JBColor.BLUE;//UIManager.getColor("nb.html.link.foreground") != null ? UIManager.getColor("nb.html.link.foreground") : new Color(0x164B7B);
