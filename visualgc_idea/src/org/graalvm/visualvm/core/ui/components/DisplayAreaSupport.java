...
class DisplayAreaSupport {
    ...
    static final Color BORDER_COLOR_NORMAL = new JBColor(Gray._192, Gray._64);
    static final Color BORDER_COLOR_HIGHLIGHT =  new JBColor(Gray._128, Gray._90);// !UISupport.isDarkResultsBackground() ? new Color(128, 128, 128) : new Color(90, 90, 90);
    static final Color BACKGROUND_COLOR_NORMAL = new JBColor(Gray._245, Gray._50);// !UISupport.isDarkResultsBackground() ? ;
    static final Color BACKGROUND_COLOR_HIGHLIGHT = new JBColor(Gray._235, Gray._55);
    ...
    private static final Color TABBUTTON_FOCUS_COLOR = JBColor.BLACK;
