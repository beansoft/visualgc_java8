...
public final class Windows8VectorCloseButton extends VectorIcon {
    public static final Icon DEFAULT = new Windows8VectorCloseButton(false);
    public static final Windows8VectorCloseButton HOVERED = new Windows8VectorCloseButton(true);
    ...
    protected void paintIcon(Component c, Graphics2D g, int width, int height, double scaling) {
        ...
        if (pressed || hovered) {
            g.setColor( hovered? new Color(199, 79, 80, 255) : new Color(71, 77, 80, 255));
